...
#if (defined(__i386__) || defined(__amd64__) || defined(__arm__) || defined(__aarch64__) || defined(_M_IX86) || defined(_M_AMD64) || defined(_M_X64) || defined(_M_ARM) || defined(_M_ARM64)) && !defined(VALVE_LITTLE_ENDIAN)
