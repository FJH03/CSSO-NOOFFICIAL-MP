...
public:
	virtual void CacheResource( PrecacheResourceType_t nType, const char *pName, 
		bool bPrecache, int *pIndex = NULL ) = 0;
};
...
{
public:
	virtual void Cache( IPrecacheHandler *pPrecacheHandler, bool bPrecache, bool bIgnoreConditionals ) = 0;	
...
public:													\
	virtual void Cache( IPrecacheHandler *pPrecacheHandler, bool bPrecache, bool bIgnoreConditionals );	\
};														\
	void CResourcePrecacher::Cache( IPrecacheHandler *pPrecacheHandler, bool bPrecache, bool bIgnoreConditionals )	\
{														\
...
#define	PRECACHE( _type, _name )				pPrecacheHandler->CacheResource( _type, _name, bPrecache, NULL ); 
...
#define	PRECACHE_INDEX( _type, _name, _index )	pPrecacheHandler->CacheResource( _type, _name, bPrecache, (int*)( &(_index) ) ); 
#define	PRECACHE_CONDITIONAL( _type, _name, _condition )			\
	if ( !bIgnoreConditionals && ( _condition ) )					\
	pPrecacheHandler->CacheResource( _type, _name, bPrecache, NULL ); 
#define	PRECACHE_INDEX_CONDITIONAL( _type, _name, _index, _func )	\
	if ( bIgnoreConditionals || ( _condition ) )				\
{															\
	pPrecacheHandler->CacheResource( _type, _name, bPrecache, (int*)( &(_index) ) );	\
}
