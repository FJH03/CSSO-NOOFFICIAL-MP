...
public:
	...
	virtual void Render( IMatRenderContext *pRenderContext, 
						 CParticleCollection *pParticles, void *pContext, int nViewRecursionDepth ) const
	{
	}
...
public:
	...
	void Render( int nViewRecursionLevel, IMatRenderContext *pRenderContext, bool bTranslucentOnly = false, void *pCameraObject = NULL );
